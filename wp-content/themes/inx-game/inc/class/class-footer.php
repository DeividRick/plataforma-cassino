	...
	*/
	public function site_footer_info (){
		...
		$html = '<div class="container site_info">
			...
			$html  .= '<span class="dev_info">'.sprintf( esc_html__( 'Theme : %1$s theme By aThemeArt - Proudly powered by WordPress.', 'inx-game' ), '<a href="'. esc_url( 'https://wordpress.org/themes/inx-game/' ) .'" target="_blank" rel="nofollow">'.esc_html_x( 'Inx Game', 'credit - theme', 'inx-game' ).'</a>' ).'</span>';
